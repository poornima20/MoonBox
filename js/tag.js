...
function applySearchFilter() {
    ...
    if (tagOrderMode === "alphabetical") {
        ...
        const letters =
            grid.querySelectorAll(".tag-letter");
        ...
        letters.forEach(letter => {
            ...
            while (
                next &&
                !next.classList.contains("tag-letter")
            ) {
...
function createModal({
    ...
    overlay.className =
        `tag-modal-overlay ${className}`.trim();
...
function openAddTagModal() {
    ...
    const modal =
        createModal({
            title: "Add Tag",
            subtitle:
                "Create a new tag to organize your music."
        });
            ...
            event => {
                ...
                const selectedIcon =
                    document.querySelector(
                        "#addTagIconPicker .tag-icon-option.selected"
                    )?.dataset.icon ||
                    "moon";
...
function openEditTagsModal() {
    ...
    const modal =
        createModal({
            title: "Edit Tags",
            subtitle:
                "Rename, change icons or delete your tags.",
    ...
    document
        ...
        .addEventListener(
            ...
            event => {
                ...
                const newIcon =
                    document.querySelector(
                        "#editTagIconPicker .tag-icon-option.selected"
                    )?.dataset.icon ||
                    tag.icon;
...
function openCustomOrderModal() {
    ...
    const modal =
        createModal({
            title: "Custom Order",
            subtitle:
                "Drag tags to arrange your preferred order.",
